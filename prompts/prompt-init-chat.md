...
4. If the workspace is judigot/template-monorepo, also read settings/ecosystem.md.
...
7. For React, Next.js, Turborepo, or Vercel, fetch the official maker skill from settings/stack.md / settings/references.md. Do not download those packs. Vite, Hono, and Zod have no official pack.
