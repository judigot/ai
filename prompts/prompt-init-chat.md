...
```text
Before any implementation, load my agentic workflow from https://github.com/judigot/ai. Start at AGENTS.md. This chat's workspace is the app I am building, not https://github.com/judigot/ai, unless I am changing the overlay. Do not clone https://github.com/judigot/ai.
...
7. Never download other people's skill repos into https://github.com/judigot/ai. Reference the URLs only.
```

## After this prompt

Wait for the implementation task. Do not clone https://github.com/judigot/ai. Do not start coding.
